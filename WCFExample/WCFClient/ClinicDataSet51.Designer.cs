...
namespace WCFClient {
    ...
    public partial class ClinicDataSet5 : global::System.Data.DataSet {
        ...
        public partial class DoctorDataTable : global::System.Data.TypedTableBase<DoctorRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public DoctorRow AddDoctorRow(System.Guid Id, string Name, System.Guid UserId) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public DoctorRow FindById(System.Guid Id) {
        ...
        public partial class DoctorRow : global::System.Data.DataRow {
            ...
            public System.Guid Id {
                get {
                    return ((global::System.Guid)(this[this.tableDoctor.IdColumn]));
                }
                set {
...
namespace WCFClient.ClinicDataSet5TableAdapters {
    ...
    public partial class DoctorTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Doctor] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_N" +
                "ame) AND ([UserId] = @Original_UserId))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Doctor] ([Id], [Name], [UserId]) VALUES (@Id, @Name, @UserId);" +
                "\r\nSELECT Id, Name, UserId FROM Doctor WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Doctor] SET [Id] = @Id, [Name] = @Name, [UserId] = @UserId WHERE ((" +
                "[Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([UserId] = @Original_Use" +
                "rId));\r\nSELECT Id, Name, UserId FROM Doctor WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, UserId FROM dbo.Doctor";
        ...
        public virtual int Fill(ClinicDataSet5.DoctorDataTable dataTable) {
        ...
        public virtual ClinicDataSet5.DoctorDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ClinicDataSet5.DoctorDataTable dataTable = new ClinicDataSet5.DoctorDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ClinicDataSet5.DoctorDataTable dataTable) {
